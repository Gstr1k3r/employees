...
export const getAllEmployees = () => db.prepare(`SELECT * FROM posts`).all();
...
// Initial Seed Adatok
const { employeeCount: employeeCount } = db
  .prepare(`SELECT COUNT(*) AS employeeCount FROM posts`)
  .get();
...
if (employeeCount === 0) {
  const initialEmployees = [
    ...
    },
    {
      ...
      lastname: "Németh",
      firstname: "Balázs",
      position: "Rendszeradminisztrátor",
      salary: 670000,
      department: "IT",
      gender: "Férfi",
      holiday_days: 26,
    ...
    },
    {
      ...
      lastname: "Fodor",
      firstname: "Lilla",
      position: "Adatbázis Adminisztrátor",
      salary: 820000,
      department: "IT",
      gender: "Nő",
      holiday_days: 23,
    ...
    },
    {
      ...
      lastname: "Papp",
      firstname: "Bence",
      position: "Értékesítési Képviselő",
      salary: 550000,
      department: "Sales",
      gender: "Férfi",
      holiday_days: 20,
    ...
    },
    {
      ...
      lastname: "Kozma",
      firstname: "László",
      position: "Machine Learning Mérnök",
      salary: 1100000,
      department: "Analytics",
      gender: "Férfi",
      holiday_days: 24,
    ...
    },
    {
      ...
      lastname: "Veres",
      firstname: "Bianka",
      position: "Ügyfélszolgálati Munkatárs",
      salary: 450000,
      department: "Support",
      gender: "Nő",
      holiday_days: 20,
    ...
    },
    {
      ...
      lastname: "Kelemen",
      firstname: "Zoltán",
      position: "Infrastruktúra Mérnök",
      salary: 910000,
      department: "IT",
      gender: "Férfi",
      holiday_days: 26,
    ...
    },
    {
      ...
      lastname: "Somogyi",
      firstname: "Virág",
      position: "Belső Kommunikációs Specialist",
      salary: 580000,
      department: "HR",
      gender: "Nő",
      holiday_days: 22,
